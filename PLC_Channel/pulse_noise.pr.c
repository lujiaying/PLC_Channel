/* Process model C form file: pulse_noise.pr.c */
/* Portions of this file copyright 1986-2008 by OPNET Technologies, Inc. */



/* This variable carries the header into the object file */
const char pulse_noise_pr_c [] = "MIL_3_Tfile_Hdr_ 145A 30A modeler 7 549FCBBF 549FCBBF 1 lu-wspn lu 0 0 none none 0 0 none 0 0 0 0 0 0 0 0 1bcc 1                                                                                                                                                                                                                                                                                                                                                                                                               ";
#include <string.h>
...
void
pulse_noise (OP_SIM_CONTEXT_ARG_OPT)
	{
#if !defined (VOSD_NO_FIN)
...
void
_op_pulse_noise_diag (OP_SIM_CONTEXT_ARG_OPT)
	{
	/* No Diagnostic Block */
	}
...
void
_op_pulse_noise_terminate (OP_SIM_CONTEXT_ARG_OPT)
	{

	FIN_MT (_op_pulse_noise_terminate ())
...
/* local variable prs_ptr in _op_pulse_noise_svar function. */
...
_op_pulse_noise_init (int * init_block_ptr)
	...
	obtype = Vos_Define_Object_Prstate ("proc state vars (pulse_noise)",
...
VosT_Address
_op_pulse_noise_alloc (VosT_Obtype obtype, int init_block)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	pulse_noise_state * ptr;
	FIN_MT (_op_pulse_noise_alloc (obtype))

	ptr = (pulse_noise_state *)Vos_Alloc_Object (obtype);
	if (ptr != OPC_NIL)
		{
		ptr->_op_current_block = init_block;
#if defined (OPD_ALLOW_ODB)
		ptr->_op_current_state = "pulse_noise [wait_sys_inited enter execs]";
#endif
		}
